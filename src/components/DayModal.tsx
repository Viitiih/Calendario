  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-end sm:items-center justify-center p-0 sm:p-4">
      ...
      <motion.div 
        ...
        className={cn(
          "relative w-full max-w-md rounded-t-[32px] sm:rounded-[32px] shadow-2xl flex flex-col border transition-colors duration-300",
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-6 pb-24" ref={scrollRef} style={{ WebkitOverflowScrolling: "touch" }}>
